...
const CountriesTable = ({ countries}) => {
  ...
  return (
    <TableContainer component={Paper}>
      <Table className="minWidth" aria-label="customized table">
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell align="right">Area&nbsp;(sq.km)</StyledTableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {countries.map((country) => (
            <StyledTableRow key={country.name}>
              ...
              <StyledTableCell align="right">{country.area}</StyledTableCell>
            </StyledTableRow>
          ))}
        </TableBody>
      </Table>
